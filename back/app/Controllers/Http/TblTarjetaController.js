...
class TblTarjetaController {
    ...
    if(request.input('newRegister2')) {
      ...
      data.actividad_economica = newRegister2.actividad_economica;
      data.anos_construccion = newRegister2.anos_construccion;
      data.iluminacion_interior = newRegister2.iluminacion_interior;
      data.humo_interior = newRegister2.humo_interior;
      ...
      data.afectaciones_externas = newRegister2.afectaciones_externas;
      data.observa_afectacion = newRegister2.observa_afectacion;
      data.kiosko_digital = newRegister2.kiosko_digital;
      data.zonas_deportivas = newRegister2.zonas_deportivas;
      data.parque_recreativo = newRegister2.parque_recreativo;
      data.gimnasio = newRegister2.gimnasio;
      data.salon_comunal = newRegister2.salon_comunal;
      data.escuela = newRegister2.escuela;
      data.colegio = newRegister2.colegio;
      data.iglesia = newRegister2.iglesia;
      data.polideportivo = newRegister2.polideportivo;
      data.escuela_deportiva = newRegister2.escuela_deportiva;
      data.escuela_cultural = newRegister2.escuela_cultural;
      data.senal_radio = newRegister2.senal_radio;
      data.senal_tv = newRegister2.senal_tv;
      data.telefonia_fija = newRegister2.telefonia_fija;
      data.telefonia_celular = newRegister2.telefonia_celular;
      data.internet = newRegister2.internet;
      data.computador = newRegister2.computador;
      data.celular = newRegister2.celular;
      data.tablet = newRegister2.tablet;
      data.telivisor = newRegister2.telivisor;
      data.radio = newRegister2.radio;
      data.videojuegos = newRegister2.videojuegos;
      data.tipo_via = newRegister2.tipo_via;
      data.consumo_fruta_verdura = newRegister2.consumo_fruta_verdura;
      data.consumo_proteina = newRegister2.consumo_proteina;
      data.porque_noconsume = newRegister2.porque_noconsume;
      data.tien_huerta = newRegister2.tien_huerta;
      data.frutas = newRegister2.frutas;
      data.verduras_hotalizas = newRegister2.verduras_hotalizas;
      data.raices_tuberculos = newRegister2.raices_tuberculos;
      data.leguminozas = newRegister2.leguminozas;
      data.tien_animales_consumo = newRegister2.tien_animales_consumo;
      data.aves = newRegister2.aves;
      data.peces = newRegister2.peces;
      data.vacas = newRegister2.vacas;
      data.porcinos = newRegister2.porcinos;
      data.ovinos = newRegister2.ovinos;
      data.curies_conejos = newRegister2.curies_conejos;
      data.otros = newRegister2.otros;
      data.habitantes = newRegister2.habitantes;
      data.ingresos_habitantes = newRegister2.ingresos_habitantes;
      data.clasificacion_pobreza = newRegister2.clasificacion_pobreza;
      data.proyecto_vivienda = newRegister2.proyecto_vivienda;
      data.clasificacion_riesgo_vivienda = newRegister2.clasificacion_riesgo_vivienda;
