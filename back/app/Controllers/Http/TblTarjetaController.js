...
class TblTarjetaController {
    ...
    if(value.newRegister2) {
      register.ingresos_mensuales_vivienda = value.newRegister2.ingresos_mensuales_vivienda;
      register.alcantarillado = value.newRegister2.alcantarillado;
      register.gas = value.newRegister2.gas;
      register.actividad_economica = value.newRegister2.actividad_economica;
      register.anos_construccion = value.newRegister2.anos_construccion;
      register.iluminacion_interior = value.newRegister2.iluminacion_interior;
      register.humo_interior = value.newRegister2.humo_interior;
      register.tratamiento_agua = value.newRegister2.tratamiento_agua;
      register.que_hace_res_organicos = value.newRegister2.que_hace_res_organicos;
      register.que_hace_res_peligrosos = value.newRegister2.que_hace_res_peligrosos;
      register.moscas = value.newRegister2.moscas;
      register.pulgas = value.newRegister2.pulgas;
      register.garrapatas = value.newRegister2.garrapatas;
      register.cinches = value.newRegister2.cinches;
      register.niguas = value.newRegister2.niguas;
      register.control_vectores = value.newRegister2.control_vectores;
      register.realizo_control_vectores_institucion = value.newRegister2.realizo_control_vectores_institucion;
      register.focos_contaminacion = value.newRegister2.focos_contaminacion;
      register.carroneros_serca_vivienda = value.newRegister2.carroneros_serca_vivienda;
      register.afectaciones_externas = value.newRegister2.afectaciones_externas;
      register.observa_afectacion = value.newRegister2.observa_afectacion;
      register.kiosko_digital = value.newRegister2.kiosko_digital;
      register.zonas_deportivas = value.newRegister2.zonas_deportivas;
      register.parque_recreativo = value.newRegister2.parque_recreativo;
      register.gimnasio = value.newRegister2.gimnasio;
      register.salon_comunal = value.newRegister2.salon_comunal;
      register.escuela = value.newRegister2.escuela;
      register.colegio = value.newRegister2.colegio;
      register.iglesia = value.newRegister2.iglesia;
      register.polideportivo = value.newRegister2.polideportivo;
      register.escuela_deportiva = value.newRegister2.escuela_deportiva;
      register.escuela_cultural = value.newRegister2.escuela_cultural;
      register.senal_radio = value.newRegister2.senal_radio;
      register.senal_tv = value.newRegister2.senal_tv;
      register.telefonia_fija = value.newRegister2.telefonia_fija;
      register.telefonia_celular = value.newRegister2.telefonia_celular;
      register.internet = value.newRegister2.internet;
      register.computador = value.newRegister2.computador;
      register.celular = value.newRegister2.celular;
      register.tablet = value.newRegister2.tablet;
      register.telivisor = value.newRegister2.telivisor;
      register.radio = value.newRegister2.radio;
      register.videojuegos = value.newRegister2.videojuegos;
      register.tipo_via = value.newRegister2.tipo_via;
      register.consumo_fruta_verdura = value.newRegister2.consumo_fruta_verdura;
      register.consumo_proteina = value.newRegister2.consumo_proteina;
      register.porque_noconsume = value.newRegister2.porque_noconsume;
      register.tien_huerta = value.newRegister2.tien_huerta;
      register.frutas = value.newRegister2.frutas;
      register.verduras_hotalizas = value.newRegister2.verduras_hotalizas;
      register.raices_tuberculos = value.newRegister2.raices_tuberculos;
      register.leguminozas = value.newRegister2.leguminozas;
      register.tien_animales_consumo = value.newRegister2.tien_animales_consumo;
      register.aves = value.newRegister2.aves;
      register.peces = value.newRegister2.peces;
      register.vacas = value.newRegister2.vacas;
      register.porcinos = value.newRegister2.porcinos;
      register.ovinos = value.newRegister2.ovinos;
      register.curies_conejos = value.newRegister2.curies_conejos;
      register.otros = value.newRegister2.otros;
      register.habitantes = value.newRegister2.habitantes;
      register.ingresos_habitantes = value.newRegister2.ingresos_habitantes;
      register.clasificacion_pobreza = value.newRegister2.clasificacion_pobreza;
      register.proyecto_vivienda = value.newRegister2.proyecto_vivienda;
      register.clasificacion_riesgo_vivienda = value.newRegister2.clasificacion_riesgo_vivienda;
      register.clasificacion_saneamiento = value.newRegister2.clasificacion_saneamiento;
    }
